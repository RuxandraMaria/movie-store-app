...
export default class DramaGenre extends Component {
    ...
    async componentDidMount() {
        let movies = await  customAxios.get('media-service/v1/GetMediaByGenre?genre=Drama', REQUEST_HEADER_WITH_CREDENTIAL);
